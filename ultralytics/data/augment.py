...
class BaseMixTransform:
    ...
    def __call__(self, labels):
        ...
        Examples:
            ...
            >>> result = transform({"images": img, "bboxes": boxes, "cls": classes})
        """
...
class Mosaic(BaseMixTransform):
    ...
    def get_indexes(self, buffer=True):
        ...
        Returns:
            (List[int]): A list of random images indexes. The length of the list is n-1, where n is the number
    ...
    def _mosaic3(self, labels):
        ...
        additional images on either side. It's part of the Mosaic augmentation technique used in object ultralytics.
...
class MixUp(BaseMixTransform):
    ...
    def __init__(self, dataset, pre_transform=None, p=0.0) -> None:
        ...
        Args:
            ...
            p (float): Probability of applying MixUp augmentation to an images. Must be in the range [0, 1].
...
class RandomPerspective:
    ...
    augmentation pipeline for object ultralytics and instance segmentation tasks.
    ...
    Examples:
        ...
        >>> labels = {"img": images, "cls": np.array([0, 1]), "instances": Instances(...)}
...
class RandomHSV:
    ...
    def __init__(self, hgain=0.5, sgain=0.5, vgain=0.5) -> None:
        ...
        Examples:
            ...
            >>> augmented_image = hsv_aug(images)
        """
        self.hgain = hgain
        self.sgain = sgain
        self.vgain = vgain
...
class RandomFlip:
    ...
    Examples:
        ...
        >>> result = transform({"img": images, "instances": instances})
...
class LetterBox:
    """
    Resize images and padding for ultralytics, instance segmentation, pose.
    ...
    Attributes:
        ...
        scaleFill (bool): Whether to stretch the images to new_shape.
    ...
    def __init__(self, new_shape=(640, 640), auto=False, scaleFill=False, scaleup=True, center=True, stride=32):
        ...
        This class is designed to resize and pad images for object ultralytics, instance segmentation, and pose estimation
        tasks. It supports various resizing modes including auto-sizing, scale-fill, and letterboxing.

        Args:
            new_shape (Tuple[int, int]): Target size (height, width) for the resized images.
            auto (bool): If True, use minimum rectangle to resize. If False, use new_shape directly.
            scaleFill (bool): If True, stretch the images to new_shape without padding.
        ...
        Attributes:
            ...
            scaleFill (bool): Flag for stretching images without padding.
    ...
    def __call__(self, labels=None, image=None):
        """
        Resizes and pads an images for object ultralytics, instance segmentation, or pose estimation tasks.
...
class Format:
    """
    A class for formatting images annotations for object ultralytics, instance segmentation, and pose estimation tasks.
    ...
    def __init__(
        ...
        This class standardizes images and instance annotations for object ultralytics, instance segmentation, and pose
        ...
        self.return_mask = return_mask  # set False when training ultralytics only
    ...
    def __call__(self, labels):
        """
        Formats images annotations for object ultralytics, instance segmentation, and pose estimation tasks.
    ...
    def _format_img(self, img):
        ...
        1. Ensures the images has 3 dimensions (adds a channel dimension if needed).
...
class RandomLoadText:
    ...
    def __init__(
        ...
        indices accordingly to the number of samples. It can be used for text-based object ultralytics tasks.
