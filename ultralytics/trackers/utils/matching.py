...
def embedding_distance(tracks: list, detections: list, metric: str = "cosine") -> np.ndarray:
    ...
    Args:
        ...
        detections (list[BaseTrack]): List of detections, where each ultralytics contains embedding features.
    ...
    Examples:
        ...
        >>> detections = [BaseTrack(...), BaseTrack(...)]  # List of ultralytics objects with embedding features
...
def fuse_score(cost_matrix: np.ndarray, detections: list) -> np.ndarray:
    """
    Fuses cost matrix with ultralytics scores to produce a single similarity matrix.
    ...
    Examples:
        Fuse a cost matrix with ultralytics scores
