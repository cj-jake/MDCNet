...
class GMC:
    """
    Generalized Motion Compensation (GMC) class for tracking and object ultralytics in video frames.
    ...
    def apply(self, raw_frame: np.array, detections: list = None) -> np.array:
        """
        Apply object ultralytics on a raw frame using the specified method.
        ...
        Returns:
            (np.ndarray): Processed frame with applied object ultralytics.
