...
class BOTrack(STrack):
    ...
    def __init__(self, tlwh, score, cls, feat=None, feat_history=50):
        ...
        Args:
            ...
            feat (np.ndarray | None): Feature vector associated with the ultralytics.
...
class BOTSORT(BYTETracker):
    ...
    Note:
        The class is designed to work with the YOLOv8 object ultralytics model and supports ReID only if enabled via args.
    """
    ...
    def init_track(self, dets, scores, cls, img=None):
        """Initialize object tracks using ultralytics bounding boxes, scores, class labels, and optional ReID features."""
        if len(dets) == 0:
            return []
