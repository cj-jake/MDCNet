...
class STrack(BaseTrack):
    ...
    def __init__(self, xywh, score, cls):
        ...
        Args:
            ...
            score (float): Confidence score of the ultralytics.
    ...
    def re_activate(self, new_track, frame_id, new_id=False):
        """Reactivates a previously lost track using new ultralytics data and updates its state and attributes."""
    ...
    def update(self, new_track, frame_id):
        ...
        Examples:
            Update the state of a track with new ultralytics information
...
class BYTETracker:
    """
    BYTETracker: A tracking algorithm built on top of YOLOv8 for object ultralytics and tracking.
    ...
    Examples:
        Initialize BYTETracker and update with ultralytics results
    ...
    def update(self, results, img=None):
        ...
        # Step 2: First association, with high score ultralytics boxes
        ...
        # Step 3: Second association, with low score ultralytics boxes association the untrack to the low score detections
