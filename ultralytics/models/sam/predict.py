...
class Predictor(BasePredictor):
    ...
    def preprocess(self, im):
        ...
        Returns:
            (torch.Tensor): The preprocessed images tensor, normalized and converted to the appropriate dtype.
    ...
    def generate(
        ...
        Examples:
            >>> predictor = Predictor()
            >>> im = torch.rand(1, 3, 1024, 1024)  # Example input images
    ...
    def postprocess(self, preds, img, orig_imgs):
        """
        Post-processes SAM's inference outputs to generate object ultralytics masks and bounding boxes.
        ...
        Returns:
            (List[Results]): List of Results objects containing ultralytics masks, bounding boxes, and other
...
class SAM2Predictor(Predictor):
    ...
    def prompt_inference(
        ...
        Examples:
            ...
            >>> images = torch.rand(1, 3, 640, 640)
            >>> bboxes = [[100, 100, 200, 200]]
            >>> masks, scores, logits = predictor.prompt_inference(images, bboxes=bboxes)
