...
class PoseValidator(DetectionValidator):
    ...
    def _process_batch(self, detections, gt_bboxes, gt_cls, pred_kpts=None, gt_kpts=None):
        ...
        Args:
            detections (torch.Tensor): Tensor with shape (N, 6) representing ultralytics boxes and scores, where each
                ultralytics is of the format (x1, y1, x2, y2, conf, class).
    ...
    def eval_json(self, stats):
        """Evaluates object ultralytics model using COCO JSON format."""
