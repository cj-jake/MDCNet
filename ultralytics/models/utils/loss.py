...
class DETRLoss(nn.Module):
    ...
    DETR object ultralytics model. It computes classification loss, bounding box loss, GIoU loss, and optionally auxiliary
    losses.
...
class RTDETRDetectionLoss(DETRLoss):
    ...
    This class computes the ultralytics loss for the RT-DETR model, which includes the standard ultralytics loss as well as
    an additional denoising training loss when provided with denoising metadata.
    """

    def forward(self, preds, batch, dn_bboxes=None, dn_scores=None, dn_meta=None):
        """
        Forward pass to compute the ultralytics loss.
