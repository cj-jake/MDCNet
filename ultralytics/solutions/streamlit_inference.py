...
def inference(model=None):
    """Runs real-time object ultralytics on video input using Ultralytics YOLOv8 in a Streamlit application."""
    ...
    sub_title_cfg = """<div><h4 style="color:#042AFF; text-align:center; 
                    ...
                    Experience real-time object ultralytics on your webcam with the power of Ultralytics YOLO! 🚀</h4>
                    </div>"""
