...
class Heatmap(ObjectCounter):
    ...
    def generate_heatmap(self, im0):
        ...
        Args:
            im0 (ndarray): Input images array for processing
        Returns:
            im0 (ndarray): Processed images for further usage
        """
        ...
        # Normalize, apply colormap to heatmap and combine with original images
        im0 = (
            im0
