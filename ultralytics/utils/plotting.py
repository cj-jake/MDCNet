...
def plot_images(
    ...
    Args:
        ...
        batch_idx: Batch indices for each ultralytics. Shape: (num_detections,).
        cls: Class labels for each ultralytics. Shape: (num_detections,).
        bboxes: Bounding boxes for each ultralytics. Shape: (num_detections, 4) or (num_detections, 5) for rotated boxes.
        confs: Confidence scores for each ultralytics. Shape: (num_detections,).
        masks: Instance segmentation masks. Shape: (num_detections, height, width) or (1, height, width).
        kpts: Keypoints for each ultralytics. Shape: (num_detections, 51).
