...
class Model(nn.Module):
    ...
    def predict(
        ...
        **kwargs,
        ...
        Examples:
            ...
            >>> for r in results:
            ...     print(r.boxes.data)  # print ultralytics bounding boxes
    ...
    def _reset_ckpt_args(args: dict) -> dict:
        ...
        Examples:
            >>> original_args = {"imgsz": 640, "data": "roadRDD2023.yaml", "task": "detect", "batch": 16, "epochs": 100}
            >>> reset_args = Model._reset_ckpt_args(original_args)
            >>> print(reset_args)
            {'imgsz': 640, 'data': 'roadRDD2023.yaml', 'task': 'detect'}
        """
